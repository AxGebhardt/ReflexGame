...
<head>
    ...
    <?php if ($_SESSION['suchanfrage_ergebnis'] == true){
				echo "<link rel=\"stylesheet\" type=\"text/css\" href=\"css/profile_search.css.php\" >";
			}
			else{
				echo "<link rel=\"stylesheet\" type=\"text/css\" href=\"css/profile_search2.css.php\" >";
				}	
	?>			
...
<div class="header_top">
    	<!-- <a href="game.php"> --> <img src="images/assets/profile_search_bannerlogo.png" class="banner_logo" alt="Logo"/> <!-- </a> --> 
 </div>
    <!-- Header --> 
    ...
    <div class="navigation">
    	 <ul>
  			...
  			<li><a class="deactive" href="">News</a></li>
  ...
  <!-- Script -->	
    ...
    <div class="myprofile_topbar">
    	<div class="myprofile_avatar">
        	<img src="<?php echo $_SESSION['suche_avatar'];?>" height="150px" width="150px" />
        </div>
        <div class="myprofile_name">
        	<span class="username_high"><?php echo $_SESSION['suche_username']; ?></span>
        </div>
        <div class="myprofile_level">
        	Level: <span class="myprofile_level_zahl"><?php echo $_SESSION['suche_level']; ?></span>
            <div id="myProgress">
  				<div id="myBar">
  				</div>
			</div>
        ...
        <div class="myprofile_score">
        	Score: <span class="myprofile_score_zahl"><?php echo $_SESSION['suche_score']; ?></span>
        </div>
    </div>
    ...
    <div class="myprofile_main">
    	<div class="myprofile_achievements">
            ...
            <div class="myprofile_achievements_picture_box">
				...
				<?php if($_SESSION['suche_ach_1'] == 0){echo "<img class=\"myprofile_achievements_picture_locked\" src=\"images/ach/1_0.png\" height=\"75px\" width=\"75px\"/>"; }else{ echo "<img class=\"myprofile_achievements_picture\" src=\"images/ach/1_1.png\" height=\"75px\" width=\"75px\"/>";} ?>
                <span class="tooltiptext">Get 50 Clicks in One Game!</span>
                </div>
                
                <div class="myprofile_achievements_picture_standart">
                <?php if($_SESSION['suche_ach_2'] == 0){echo "<img class=\"myprofile_achievements_picture_locked\" src=\"images/ach/2_0.png\" height=\"75px\" width=\"75px\"/>"; }else{ echo "<img class=\"myprofile_achievements_picture\" src=\"images/ach/2_1.png\" height=\"75px\" width=\"75px\"/>";} ?>
                <span class="tooltiptext">Get 100 Clicks in One Game!</span>
                </div>
                
                <div class="myprofile_achievements_picture_standart">
                <?php if($_SESSION['suche_ach_3'] == 0){echo "<img class=\"myprofile_achievements_picture_locked\" src=\"images/ach/3_0.png\" height=\"75px\" width=\"75px\"/>"; }else{ echo "<img class=\"myprofile_achievements_picture\" src=\"images/ach/3_1.png\" height=\"75px\" width=\"75px\"/>";} ?>
                <span class="tooltiptext">Get 150 Clicks in One Game!</span>
                </div>
                
                <div class="myprofile_achievements_picture_standart_last">
                <?php if($_SESSION['suche_ach_4'] == 0){echo "<img class=\"myprofile_achievements_picture_locked_last\" src=\"images/ach/4_0.png\" height=\"75px\" width=\"75px\"/>"; }else{ echo "<img class=\"myprofile_achievements_picture_last\" src=\"images/ach/4_1.png\" height=\"75px\" width=\"75px\"/>";} ?>
                <span class="tooltiptext">Get into the Top 3!</span>
                </div>
                
                <div class="myprofile_achievements_picture_standart">
                <?php if($_SESSION['suche_ach_5'] == 0){echo "<img class=\"myprofile_achievements_picture_locked\" src=\"images/ach/5.png\" height=\"75px\" width=\"75px\"/>"; }else{ echo "<img class=\"myprofile_achievements_picture\" src=\"images/ach/5.png\" height=\"75px\" width=\"75px\"/>";} ?>
                <span class="tooltiptext">Play your first Game!</span>
                </div>
                
                <div class="myprofile_achievements_picture_standart">
                <?php if($_SESSION['suche_ach_6'] == 0){echo "<img class=\"myprofile_achievements_picture_locked\" src=\"images/ach/6.png\" height=\"75px\" width=\"75px\"/>"; }else{ echo "<img class=\"myprofile_achievements_picture\" src=\"images/ach/6.png\" height=\"75px\" width=\"75px\"/>";} ?>
    ...
    <?php }else{ ?>
    			<div class="myprofile_topbar">
                	<div class="myprofile_name">
        					We couldn't find <span class="username_high"><?php echo $_SESSION['suche_eingabe']; ?></span> in our Database
        			</div>
                </div>
    <?php } ?> 
    <!-- Content -->
