...
<head>
	...
	<link rel="stylesheet" type="text/css" href="css/myprofile.css.php" >
...
<div class="header_top">
    	<!-- <a href="game.php"> --> <img src="images/assets/my_profile_bannerlogo.png" class="banner_logo" alt="Logo"/> <!-- </a> --> 
 </div>
    <!-- Header --> 
